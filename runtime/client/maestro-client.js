...
const METHOD_NAMES = ["initialize", "snapshot", "subscribe", "health", "inspectProject", "listProjects", "listMissions", "listRuns", "createMission", "updateMission", "createRun", "executeRun", "cancelRun", "listProviders", "skillsList", "resolveAttention", "listTerminalSessions", "createTerminalSession", "attachTerminalSession", "closeTerminalSession", "focusTerminalSession", "inputTerminalSession", "resizeTerminalSession", "snapshotTerminalSession", "action"];
const MAESTRO_CLIENT_INTERFACE = Object.freeze(Object.fromEntries(METHOD_NAMES.map((name) => [name, "method"])));
const REJECTION_REASONS = Object.freeze(["gate.required", "not_running", "double_confirm", "invalid_payload", "offline", "deprecated"]);
